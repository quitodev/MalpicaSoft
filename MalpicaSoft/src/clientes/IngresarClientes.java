...
public class IngresarClientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelIngresar.setText("REGISTRAR CLIENTES NUEVOS");
        ...
        labelDatos1.setBounds(13, 60, 204, 23);
        ...
        labelCodigo.setBounds(13, 90, 89, 23);
        ...
        labelNombre.setBounds(148, 90, 147, 23);
        ...
        labelCondicion.setBounds(367, 90, 94, 23);
        ...
        labelDatos2.setBounds(13, 170, 254, 23);
        ...
        labelTipo.setBounds(610, 200, 87, 23);
    ...
    private void botonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardarActionPerformed
        ...
        if (!datoCodigo.equals("") && !datoNombre.equals("") && datoCondicion.length() == 2 && !datoDescripcion.equals("") && datoNroCuit.length() == 13
            ...
            try {
                ...
                PreparedStatement sta = con.prepareStatement("select * from clientes where codigo = '" + datoCodigo + "'");
                ...
                if (res.next()) {
                    ...
                    labelMensaje.setText("El cliente que intenta registrar ya fue registrado anteriormente!");
                    ...
                    try {
                        ...
                        PreparedStatement sta1 = con1.prepareStatement("insert into clientes "
                                + "values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                        ...
                        labelMensaje.setText("El cliente se registró exitosamente!");
                        labelMensaje.setVisible(true);
