...
public class IngresarVentas extends javax.swing.JFrame {
    ...
    // Método para leer el archivo "sales.mvp" que contiene la numeración de las facturas de venta
    public void leer() {
    ...
    private void initComponents() {
        ...
        labelCodigoClienteInfo.setText("Hasta 12 letras y/o números!");
        ...
        labelCodigoCliente.setText("Cód. Cliente");
        ...
        labelNombreCliente.setText("Razón Social Cliente");
    ...
    private void botonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardarActionPerformed
        ...
        if (datoFechaVenta.length() == 8 && datoFechaVenta.matches(formatoFechaCompra) && datoNroFactura.length() == 15
            ...
            try {
                // Establece conexión con DB para consultar por nro de factura si ya fue ingresada anteriormente
                ...
                if (res.next()) {
                    ...
                    try {
                        // Si no fue creada la factura, establece conexión con DB para consultar si el cliente ya fue creado también
                        ...
                        if (res1.next()) {
                            ...
                            // Si el cliente está en la base de clientes, continúa
                            con1.close();
                    ...
                    try {
                        ...
                        if (res1.next()) {
                            // Si encuentra el código en la base de stock, actualiza el stock en la base de stock
                            ...
                            // Si no encuentra el código en la base de stock, lo almacena
                    ...
                    try {
                        // Establece conexión con DB para registrar finalmente la venta
                        Connection con1 = Conexion.conectar();
                        ...
                        labelMensaje.setText("La factura se registró exitosamente!");
                        labelMensaje.setVisible(true);
                        ...
                        // Procede a guardar el archivo "data.txt" y leerlo, sumando una unidad al número de factura
                        guardar();
                        leer();
        ...
        if (!datoCodigoCliente.equals("")) {
            ...
            try {
                ...
                if (res.next()) {
                    ...
                    labelMensaje.setForeground(new java.awt.Color(255, 90, 0));
                    labelMensaje.setText("El cliente ingresado es nuevo. Se grabará al registrar la venta!");
                    labelMensaje.setVisible(true);
        ...
        if (!datoCodigo.equals("")) {
            ...
            try {
                ...
                if (res.next()) {
                    ...
                    labelMensaje.setForeground(new java.awt.Color(255, 90, 0));
                    labelMensaje.setText("El producto ingresado es nuevo. Se grabará al registrar la venta!");
                    labelMensaje.setVisible(true);
