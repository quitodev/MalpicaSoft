...
public class ModificarProveedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("MS - Modificar proveedores");
        setUndecorated(true);
        ...
        labelModificar.setText("MODIFICAR PROVEEDORES REGISTRADOS");
    ...
    private void botonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardarActionPerformed
        ...
        if (!datoCodigo.equals("") && !datoNombre.equals("") && datoCondicion.length() == 2 && !datoDescripcion.equals("")
            ...
            try {
                ...
                PreparedStatement sta = con.prepareStatement("select * from proveedores where id = '" + ID + "'");
                ResultSet res = sta.executeQuery();

                if (res.next()) {
                    // Si ya fue creado, actualiza el resto de los datos
                    Connection con1 = Conexion.conectar();
                    PreparedStatement sta1 = con1.prepareStatement("update proveedores set codigo=?, "
                    ...
                    try {
                        ...
                        PreparedStatement sta2 = con2.prepareStatement("select codigo from compras where codigo = '" + datoCodigo + "'");
                        ResultSet res2 = sta2.executeQuery();

                        if (res2.next()) {
                            // Si ya fue creado, actualiza el resto de los datos
                            Connection con3 = Conexion.conectar();
                            PreparedStatement sta3 = con3.prepareStatement("update compras set codigo=?, razon_social=?, "
                        ...
                        JOptionPane.showConfirmDialog(null, "Error de conexión: Base compras!", "Información",
                                JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE);
                    }

                    try {
                        // Establece conexión con DB para hacer la consulta
                        Connection con4 = Conexion.conectar();
                        PreparedStatement sta4 = con4.prepareStatement("select codigo from gastos where codigo = '" + datoCodigo + "'");
                        ResultSet res4 = sta4.executeQuery();

                        if (res4.next()) {
                            // Si ya fue creado, actualiza el resto de los datos
                            Connection con5 = Conexion.conectar();
                            PreparedStatement sta5 = con5.prepareStatement("update gastos set codigo=?, razon_social=?, "
                                    + "condicion=? where codigo = '" + datoCodigo + "'");

                            sta5.setString(1, datoCodigo);
                            sta5.setString(2, datoNombre);
                            sta5.setString(3, datoCondicion);
                        ...
                        // Si no se conecta con la DB, muestra un mensaje de error
                        JOptionPane.showConfirmDialog(null, "Error de conexión: Base gastos!", "Información",
                                JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE);
                    }
                ...
                // Si no se conecta con la DB, muestra un mensaje de error
                JOptionPane.showConfirmDialog(null, "Error de conexión: Base proveedores!", "Información",
                        JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE);
            }
