...
public class IngresarGastos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelIngresar.setText("REGISTRAR GASTOS NUEVOS");
        ...
        if (datoFechaCompra.length() == 8 && datoFechaCompra.matches(formatoFechaCompra) && datoNroFactura.length() == 15
            ...
            try {
                ...
                if (res.next()) {
                    ...
                    labelMensaje.setText("La compra que intenta registrar ya fue registrada anteriormente!");
                    ...
                    try {
                        ...
                        Connection con1 = Conexion.conectar();
                        PreparedStatement sta1 = con1.prepareStatement("insert into gastos "
                                + "values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
        ...
        if (!datoCodigoProv.equals("")) {
            ...
            try {
                ...
                if (res.next()) {
                    ...
                    labelMensaje.setForeground(new java.awt.Color(255, 90, 0));
                    labelMensaje.setText("El proveedor ingresado es nuevo. Se grabará al registrar el gasto!");
                    labelMensaje.setVisible(true);
        ...
        if (!datoCodigo.equals("")) {
            ...
            try {
                ...
                if (res.next()) {
                    ...
                    labelMensaje.setForeground(new java.awt.Color(255, 90, 0));
                    labelMensaje.setText("El producto ingresado es nuevo. Se grabará al registrar el gasto!");
                    labelMensaje.setVisible(true);
