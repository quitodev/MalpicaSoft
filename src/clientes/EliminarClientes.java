...
public class EliminarClientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelEliminar.setText("ELIMINAR CLIENTES REGISTRADOS");
    ...
    private void botonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarActionPerformed
        ...
        int respuesta = JOptionPane.showConfirmDialog(null, "¿Desea eliminar el cliente? Esta acción no se puede revertir!", "Confirmación", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        ...
        switch (respuesta) {
            ...
            case JOptionPane.YES_OPTION:
                ...
                try {
                    ...
                    PreparedStatement sta = con.prepareStatement("select * from ventas where codigo = '" + datoCodigo + "'");
                    ResultSet res = sta.executeQuery();

                    if (res.next()) {
                        // Si ya está creado, muestra un mensaje de error
                        JOptionPane.showConfirmDialog(null, "No puede eliminar un cliente que tiene operaciones!\nElimínelas y vuelva a intentar..", "Información",
                        ...
                        try {
                            ...
                            PreparedStatement sta1 = con1.prepareStatement("delete from clientes where id = ?");
                            ...
                            labelMensaje.setText("El cliente fue eliminado exitosamente!");
