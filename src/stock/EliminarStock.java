 ...
 */
public class EliminarStock extends javax.swing.JFrame {
    ...
    // Método para ocultar los paneles del menú principal, el botón de eliminar y el mensaje de error
    ...
    private void initComponents() {
        ...
        fondoEliminarStock = new javax.swing.JLabel();
        campoFechaOculta = new javax.swing.JTextField();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("MS - Eliminar productos");
        setUndecorated(true);

        panelEliminar.setPreferredSize(new java.awt.Dimension(800, 500));
        ...
        panelFondoEliminar.setMinimumSize(new java.awt.Dimension(740, 370));
        ...
        panelFondoEliminar.add(panelPorDescripcionInfo);
        ...
        labelEliminar.setText("ELIMINAR PRODUCTOS REGISTRADOS");
        ...
        panelFondoEliminar.add(labelPorDescripcion);
        ...
        panelFondoEliminar.add(campoPorDescripcion);
        ...
        panelFondoEliminar.add(fondoPorDescripcion);
        ...
        botonEliminar.setBounds(475, 195, 130, 35);
        ...
        panelFondoEliminar.add(labelDatos);
        ...
        panelFondoEliminar.add(separador);
        ...
        panelFondoEliminar.add(labelMoneda);
        ...
        panelFondoEliminar.add(labelPrecioTotal);
        ...
        panelFondoEliminar.add(campoMoneda);
        ...
        panelFondoEliminar.add(campoPrecioTotal);
        ...
        panelFondoEliminar.add(fondoMoneda);
        ...
        panelFondoEliminar.add(fondoPrecioTotal);
        fondoPrecioTotal.setBounds(630, 305, 100, 40);

        fondoPanelEliminar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/varios/cuadro2.png"))); // NOI18N
        ...
        fondoPanelEliminar1.setBounds(0, 0, 740, 370);
        ...
        fondoPanelEliminar2.setBounds(-30, -80, 800, 500);

        panelEliminar.add(panelFondoEliminar);
        panelFondoEliminar.setBounds(30, 80, 740, 370);

        fondoEliminarStock.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        fondoEliminarStock.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/fondos/fondo5.jpg"))); // NOI18N
        fondoEliminarStock.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        fondoEliminarStock.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                fondoEliminarStockMouseClicked(evt);
            }
        });
        panelEliminar.add(fondoEliminarStock);
        fondoEliminarStock.setBounds(0, 0, 800, 500);
        ...
        if (!datoPorCodigo.equals("")) {
            ...
            try {
                ...
                if (res.next()) {
                    ...
                    // Establece la visibilidad del mensaje de error, oculta botones y recupera color de labels
                    labelMensaje.setVisible(false);
    ...
    private void fondoEliminarStockMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_fondoEliminarStockMouseClicked
        ...
        labelReportes.setForeground(new java.awt.Color(255, 180, 140));
        labelAyuda.setForeground(new java.awt.Color(255, 180, 140));
    }//GEN-LAST:event_fondoEliminarStockMouseClicked
    ...
    private void botonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarActionPerformed
        ...
        int respuesta = JOptionPane.showConfirmDialog(null, "¿Desea eliminar el producto? Esta acción no se puede revertir!", "Confirmación", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        ...
        switch (respuesta) {
            ...
            case JOptionPane.YES_OPTION:
                ...
                try {
                    ...
                    Connection con = Conexion.conectar();
                    PreparedStatement sta = con.prepareStatement("delete from stock where id = ?");
                    ...
                    labelMensaje.setText("El producto fue eliminado exitosamente!");
                    labelMensaje.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarStock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel fondoEliminarStock;
