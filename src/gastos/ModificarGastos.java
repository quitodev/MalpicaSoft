 ...
 */
public class ModificarGastos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelModificar.setText("MODIFICAR GASTOS REGISTRADOS");
        labelModificar.setToolTipText("");
        ...
        if (datoFechaCompra.length() == 8 && datoFechaCompra.matches(formatoFechaCompra) && datoNroFactura1.length() == 15
            ...
            try {
                ...
                if (res.next()) {
                    ...
                    Connection con1 = Conexion.conectar();
                    PreparedStatement sta1 = con1.prepareStatement("update gastos set fecha_factura=?, fecha_modif=?, hora_modif=?, nro_factura=?, codigo=?, "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarGastos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
