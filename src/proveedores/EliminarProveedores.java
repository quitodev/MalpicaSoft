...
public class EliminarProveedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("MS - Eliminar proveedores");
        setUndecorated(true);
        ...
        panelFondoEliminar.add(panelPorCodigoInfo);
        ...
        panelFondoEliminar.add(panelPorNombreInfo);
        ...
        panelFondoEliminar.add(panelPorNroCuitInfo);
        ...
        labelEliminar.setText("ELIMINAR PROVEEDORES REGISTRADOS");
        panelFondoEliminar.add(labelEliminar);
        labelEliminar.setBounds(0, 15, 740, 40);
        ...
        panelFondoEliminar.add(labelPorCodigo);
        ...
        panelFondoEliminar.add(labelPorNombre);
        ...
        panelFondoEliminar.add(labelPorNroCuit);
        ...
        panelFondoEliminar.add(campoPorCodigo);
        ...
        panelFondoEliminar.add(campoPorNombre);
        ...
        panelFondoEliminar.add(campoPorNroCuit1);
        ...
        panelFondoEliminar.add(campoPorNroCuit2);
        ...
        panelFondoEliminar.add(campoPorNroCuit3);
        ...
        panelFondoEliminar.add(fondoPorCodigo);
        ...
        panelFondoEliminar.add(fondoPorNombre);
        ...
        panelFondoEliminar.add(fondoPorNroCuit);
        ...
        botonEliminar.setBounds(475, 175, 130, 35);
        ...
        panelFondoEliminar.add(labelDatos1);
        ...
        panelFondoEliminar.add(separador1);
        ...
        panelFondoEliminar.add(labelNombre);
        ...
        panelFondoEliminar.add(labelCondicion);
        ...
        panelFondoEliminar.add(labelNroCuit);
        ...
        panelFondoEliminar.add(campoNombre);
        ...
        panelFondoEliminar.add(campoCondicion);
        ...
        panelFondoEliminar.add(campoNroCuit);
        ...
        panelFondoEliminar.add(fondoNombre);
        ...
        panelFondoEliminar.add(fondoCondicion);
        ...
        panelFondoEliminar.add(fondoNroCuit);
        ...
        panelFondoEliminar.add(labelDatos2);
        ...
        panelFondoEliminar.add(separador2);
        ...
        panelFondoEliminar.add(labelDireccion);
        ...
        panelFondoEliminar.add(labelLocalidad);
        ...
        panelFondoEliminar.add(labelContacto);
        ...
        panelFondoEliminar.add(labelTipo);
        ...
        panelFondoEliminar.add(campoDireccion);
        ...
        panelFondoEliminar.add(campoLocalidad);
        ...
        panelFondoEliminar.add(campoContacto);
        ...
        panelFondoEliminar.add(campoTipo);
        ...
        panelFondoEliminar.add(fondoDireccion);
        ...
        panelFondoEliminar.add(fondoLocalidad);
        ...
        panelFondoEliminar.add(fondoContacto);
        ...
        panelFondoEliminar.add(fondoTipo);
        ...
        fondoEliminar.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        fondoEliminar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/fondos/fondo5.jpg"))); // NOI18N
        fondoEliminar.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        fondoEliminar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                fondoEliminarMouseClicked(evt);
            }
        });
        panelEliminar.add(fondoEliminar);
        fondoEliminar.setBounds(0, 0, 800, 550);
    ...
    private void fondoEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_fondoEliminarMouseClicked
        ...
        labelReportes.setForeground(new java.awt.Color(255, 180, 140));
        labelAyuda.setForeground(new java.awt.Color(255, 180, 140));
    }//GEN-LAST:event_fondoEliminarMouseClicked
    ...
    private void botonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarActionPerformed
        ...
        int respuesta = JOptionPane.showConfirmDialog(null, "¿Desea eliminar el proveedor? Esta acción no se puede revertir!", "Confirmación", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        ...
        switch (respuesta) {
            ...
            case JOptionPane.YES_OPTION:
                ...
                try {
                    ...
                    PreparedStatement sta = con.prepareStatement("select * from compras where codigo = '" + datoCodigo + "'");
                    ResultSet res = sta.executeQuery();

                    if (res.next()) {
                        // Si ya está creado, muestra un mensaje de error
                        JOptionPane.showConfirmDialog(null, "No puede eliminar un proveedor que tiene operaciones!\nElimínelas y vuelva a intentar..", "Información",
                ...
                try {
                    ...
                    PreparedStatement sta1 = con1.prepareStatement("select * from gastos where codigo = '" + datoCodigo + "'");
                    ...
                    if (res1.next()) {
                        ...
                        try {
                            // Establece conexión con DB para efectuar la consulta por ID
                            Connection con2 = Conexion.conectar();
                            PreparedStatement sta2 = con2.prepareStatement("delete from proveedores where id = ?");

                            sta2.setInt(1, ID);

                            // Muestra mensaje de borrado exitoso, limpia campos y recupera el color de los labels
                            labelMensaje.setForeground(new java.awt.Color(0, 255, 0));
                            labelMensaje.setText("El proveedor fue eliminado exitosamente!");
                            ...
                            campoPorNroCuit2.setEditable(true);
                            campoPorNroCuit3.setEditable(true);
                            campoPorCodigo.setRequestFocusEnabled(true);
                            campoPorNombre.setRequestFocusEnabled(true);
                            campoPorNroCuit1.setRequestFocusEnabled(true);
                            campoPorNroCuit2.setRequestFocusEnabled(true);
                            campoPorNroCuit3.setRequestFocusEnabled(true);
