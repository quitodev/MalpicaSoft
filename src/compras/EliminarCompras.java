 ...
 */
public class EliminarCompras extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("MS - Eliminar compras");
        setUndecorated(true);

        panelEliminar.setName(""); // NOI18N
        ...
        labelEliminar.setText("ELIMINAR COMPRAS REGISTRADAS");
        ...
        campoCodigoProv.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
    ...
    private void botonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarActionPerformed
        ...
        int respuesta = JOptionPane.showConfirmDialog(null, "¿Desea eliminar la compra? Esta acción no se puede revertir!", "Confirmación", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                ...
                try {
                    ...
                    if (res.next()) {
                        ...
                        try {
                            ...
                            Connection con1 = Conexion.conectar();
                            PreparedStatement sta1 = con1.prepareStatement("delete from compras where id = ?");
                            ...
                            labelMensaje.setText("La compra fue eliminada exitosamente!");
                            labelMensaje.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarCompras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
