...
public class EliminarVentas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fondoEliminarVenta = new javax.swing.JLabel();
        campoFechaOculta = new javax.swing.JTextField();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("MS - Eliminar ventas");
        setUndecorated(true);
        ...
        labelEliminar.setText("ELIMINAR VENTAS REGISTRADAS");
        ...
        panelFondoEliminar.add(labelDatosCliente);
        labelDatosCliente.setBounds(15, 230, 130, 23);
        ...
        panelFondoEliminar.add(separadorCliente);
        ...
        panelFondoEliminar.add(labelFechaVenta);
        ...
        panelFondoEliminar.add(labelCodigoCliente);
        labelCodigoCliente.setBounds(265, 260, 90, 23);
        ...
        panelFondoEliminar.add(labelNombreCliente);
        labelNombreCliente.setBounds(400, 260, 147, 23);
        ...
        panelFondoEliminar.add(labelCondicionCliente);
        labelCondicionCliente.setBounds(635, 260, 98, 23);
        ...
        panelFondoEliminar.add(campoFechaVenta);
        ...
        panelFondoEliminar.add(campoCodigoCliente);
        campoCodigoCliente.setBounds(265, 285, 120, 30);
        ...
        panelFondoEliminar.add(campoNombreCliente);
        campoNombreCliente.setBounds(400, 285, 235, 30);
        ...
        panelFondoEliminar.add(campoCondicionCliente);
        ...
        panelFondoEliminar.add(fondoFechaVenta);
        ...
        panelFondoEliminar.add(fondoCodigoCliente);
        fondoCodigoCliente.setBounds(260, 280, 130, 40);

        fondoNombreCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/campos/campo-nombreprov3.png"))); // NOI18N
        panelFondoEliminar.add(fondoNombreCliente);
        fondoNombreCliente.setBounds(395, 280, 245, 40);
        ...
        panelFondoEliminar.add(fondoCondicionCliente);
        ...
        fondoEliminarVenta.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        fondoEliminarVenta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/fondos/fondo5.jpg"))); // NOI18N
        fondoEliminarVenta.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        fondoEliminarVenta.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                fondoEliminarVentaMouseClicked(evt);
            }
        });
        panelEliminar.add(fondoEliminarVenta);
        fondoEliminarVenta.setBounds(0, 0, 800, 550);
    ...
    private void fondoEliminarVentaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_fondoEliminarVentaMouseClicked
        ...
        labelReportes.setForeground(new java.awt.Color(255, 180, 140));
        labelAyuda.setForeground(new java.awt.Color(255, 180, 140));
    }//GEN-LAST:event_fondoEliminarVentaMouseClicked
    ...
    private void botonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarActionPerformed
        ...
        int respuesta = JOptionPane.showConfirmDialog(null, "¿Desea eliminar la venta? Esta acción no se puede revertir!", "Confirmación", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                ...
                try {
                    ...
                    if (res.next()) {
                        ...
                        try {
                            ...
                            Connection con1 = Conexion.conectar();
                            PreparedStatement sta1 = con1.prepareStatement("delete from ventas where id = ?");
                            ...
                            labelMensaje.setText("La venta fue eliminada exitosamente!");
                            labelMensaje.setVisible(true);
    ...
    private javax.swing.JLabel fondoEliminarVenta;
